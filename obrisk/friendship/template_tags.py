...
@register.inclusion_tag("obrisk/friendship/templates/friends.html")
def friends(user):
    """
...
@register.inclusion_tag("obrisk/friendship/templates/followers.html")
def followers(user):
    """
...
@register.inclusion_tag("obrisk/friendship/templates/following.html")
def following(user):
    """
...
@register.inclusion_tag("obrisk/friendship/templates/blockers.html")
def blockers(user):
    """
    Simple tag to grab all followers
    """
...
@register.inclusion_tag("obrisk/friendship/templates/blocking.html")
def blocking(user):
    """
    Simple tag to grab all users who follow the given user
    """
...
@register.inclusion_tag("obrisk/friendship/templates/friend_requests.html")
...
@register.inclusion_tag("obrisk/friendship/templates/friend_request_count.html")
...
@register.inclusion_tag("obrisk/friendship/templates/friend_count.html")
...
@register.inclusion_tag("obrisk/friendship/templates/friend_rejected_count.html")

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province_region', models.CharField(max_length=100, verbose_name='Province')),
                ('city', models.CharField(max_length=100, verbose_name='City')),
                ('points', models.IntegerField(default=0, verbose_name='Points')),
                ('nationality', models.CharField(blank=True, max_length=100, null=True, verbose_name='Nationality')),
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='Unknown_phone_no', max_length=128, region=None, verbose_name='Phone number')),

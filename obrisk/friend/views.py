...
#FRIENDSHIP
def view_friends(request, username, template_name="friends/friends.html"):
...
def friendship_add_friend(
    request, to_username, template_name="friends/add_friends.html"
):
...
def friendship_request_list(
    request, template_name="friends/friend_requests_list.html"
):
    """ View unread and read friendship requests """
...
def friendship_request_list_rejected(
    request, template_name="friends/requests_list.html"
):
...
def friendship_requests_detail(
    request, friendship_request_id, template_name="friends/request.html"
):
...
def followers(request, username, template_name="friends/followers.html"):
...
def following(request, username, template_name="friends/following.html"):
...
@login_required
def follower_add(
    request, followee_username, template_name="friends/add_follower.html"
):
...
@login_required
def follower_remove(
    request, followee_username, template_name="friends/remove_follower.html"
):
...
def blockers(request, username, template_name="friends/blockers.html"):
    """ List this user's followers """
    user = get_object_or_404(user_model, username=username)
...
def blocking(request, username, template_name="friends/blocking.html"):
    """ List who this user follows """
    user = get_object_or_404(user_model, username=username)
...
@login_required
def block_add(request, blocked_username, template_name="friends/add_block.html"):
    """ Create a following relationship """
...
@login_required
def block_remove(
    request, blocked_username, template_name="friends/remove_block.html"
):
    """ Remove a following relationship """
    if request.method == "POST":
        blocked = user_model.objects.get(username=blocked_username)

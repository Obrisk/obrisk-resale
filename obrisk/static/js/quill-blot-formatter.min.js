                  ...
                  if (this.currentSpec) {
                    ...
                    if (e) {
                      ...
                      Object.assign(this.overlay.style, {
                        display: "block",
                        left: n.left - r.left - 1 + t.scrollLeft + "px",
                        top: n.top - r.top + t.scrollTop + "px",
                        width: n.width + "px",
                        height: n.height + "px"
                      });
                    }
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  [
                    ...
                    t.quill.root.style.setProperty(n, e),
      ...
      var l = (function() {
        ...
        h = (function(e) {
          function t(e) {
            ...
            return (
              (n.aligner = new p.default(e.options.align)),
              (n.toolbar = new y.default()),
              n
            );
          }
          return (
            ...
            l(t, [
              ...
              },
              {
                ...
                value: function() {
                  ...
                  e &&
                    (this.formatter.overlay.removeChild(e),
            ...
            o(this, e),
              ...
              (this.alignments =
                ...
                r(n, a, {
                  ...
                  apply: function(e) {
                    i.setAlignment(e, a),
                      i.setStyle(e, "inline", "left", "0 1em 1em 0");
                  }
                }),
                r(n, l, {
                  name: l,
                ...
                r(n, u, {
                  ...
                  apply: function(e) {
                    i.setAlignment(e, u),
                      i.setStyle(e, "inline", "right", "0 0 1em 1em");
                  }
                }),
                n));
          }
          return (
            i(e, [
              ...
              },
              {
                key: "clear",
                value: function(e) {
                  e.removeAttribute(this.alignAttribute),
                    this.setStyle(e, null, null, null);
                }
              },
              {
                key: "isAligned",
                value: function(e, t) {
                  return e.getAttribute(this.alignAttribute) === t.name;
                }
              },
              {
                key: "setAlignment",
              ...
              },
              {
                ...
                value: function(e, t, n, r) {
                  this.applyStyle &&
                    (e.style.setProperty("display", t),
                    e.style.setProperty("float", n),
                    e.style.setProperty("margin", r));
                }
              }
            ]),
            e
              ...
              o(e, [
                {
                  ...
                  value: function(e, t) {
                    ...
                    return (
                      n.classList.add(e.options.align.toolbar.mainClassName),
                      this.addToolbarStyle(e, n),
                      this.addButtons(e, n, t),
                      (this.toolbar = n),
                      this.toolbar
                    );
                  }
                ...
                },
                {
                  key: "addToolbarStyle",
                  value: function(e, t) {
                    e.options.align.toolbar.mainStyle &&
                      Object.assign(t.style, e.options.align.toolbar.mainStyle);
                  }
                },
                {
                  key: "addButtonStyle",
                  value: function(e, t, n) {
                    n.options.align.toolbar.buttonStyle &&
                      (Object.assign(
                        e.style,
                        n.options.align.toolbar.buttonStyle
                      ),
                      t > 0 && (e.style.borderLeftWidth = "0")),
                      n.options.align.toolbar.svgStyle &&
                        Object.assign(
                          e.children[0].style,
                          n.options.align.toolbar.svgStyle
                        );
                ...
                },
                {
                  ...
                  value: function(e, t, n, r, o) {
                    ...
                    this.buttons.forEach(function(e) {
                      ...
                      o.isAligned(t, r)
                        ? n.options.align.toolbar.allowDeselect
                          ? o.clear(t)
                          : this.selectButton(n, e)
                        : (this.selectButton(n, e), r.apply(t)),
                      n.update();
                  }
                },
                {
                  ...
                  value: function(e, t) {
                    t.classList.add("is-selected"),
                      e.options.align.toolbar.addButtonSelectStyle &&
                        t.style.setProperty("filter", "invert(20%)");
                  }
                },
                {
                  key: "deselectButton",
              ...
              return (
                (n.onMouseDown = function(e) {
                  if (
                    ...
                    ((n.dragHandle = e.target),
                    n.setCursor(n.dragHandle.style.cursor),
                    n.formatter.currentSpec)
                  ) {
                    var t = n.formatter.currentSpec.getTargetElement();
                    if (t) {
                      var r = t.getBoundingClientRect();
                      (n.dragStartX = e.clientX),
                        (n.preDragWidth = r.width),
                        (n.targetRatio = r.height / r.width),
                        document.addEventListener("mousemove", n.onDrag),
                  ...
                  if (n.formatter.currentSpec) {
                    ...
                    if (t) {
                      var r = e.clientX - n.dragStartX,
                        o = 0;
                      o =
                        n.dragHandle === n.topLeftHandle ||
                        n.dragHandle === n.bottomLeftHandle
                          ? Math.round(n.preDragWidth - r)
                          : Math.round(n.preDragWidth + r);
                ...
                (n.onMouseUp = function() {
                  n.setCursor(""),
                    document.removeEventListener("mousemove", n.onDrag),
                ...
                (n.bottomRightHandle = n.createHandle(
                  "bottom-right",
                  "nwse-resize"
                )),
                (n.bottomLeftHandle = n.createHandle(
                  "bottom-left",
                  "nesw-resize"
                )),
                (n.dragHandle = null),
              ...
              l(t, [
                {
                  ...
                  value: function() {
                    this.formatter.overlay.appendChild(this.topLeftHandle),
                      ...
                      this.formatter.overlay.appendChild(
                ...
                },
                {
                  ...
                  value: function() {
                    this.setCursor(""),
                      ...
                      this.formatter.overlay.removeChild(
                        this.bottomRightHandle
                      ),
                ...
                },
                {
                  ...
                  value: function(e, t) {
                    ...
                    return (
                      n.classList.add(
                        this.formatter.options.resize.handleClassName
                      ),
                ...
                },
                {
                  ...
                  value: function(e) {
                    var t = "0px",
                      n = "0px";
                    e &&
                      (e.width && (t = -parseFloat(e.width) / 2 + "px"),
                      e.height && (n = -parseFloat(e.height) / 2 + "px")),
                ...
                },
                {
                  ...
                  value: function(e) {
                    if (
                      (document.body && (document.body.style.cursor = e),
          ...
          function t() {
            ...
            return (
              ...
              (r.onKeyUp = function(e) {
                if (
                  r.formatter.currentSpec &&
                  (46 === e.keyCode || 8 === e.keyCode)
                ) {
                  var t = s.default.find(
                    r.formatter.currentSpec.getTargetElement()
                  );
                  t && t.deleteAt(0), r.formatter.hide();
                }
              }),
              (a = n),
              i(r, a)
          ...
          function t(e, n) {
            ...
            return (
              (r.onTextChange = function() {
                Array.from(
                  document.querySelectorAll(r.selector + ":not([" + f + "])")
                ).forEach(function(e) {
              ...
              (r.onProxyImageClick = function() {
                (r.unclickable = r.nextUnclickable),

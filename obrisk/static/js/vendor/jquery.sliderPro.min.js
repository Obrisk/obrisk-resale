...
!(function(a, b) {
  ...
  d.prototype = {
    _init: function() {
      ...
      b(a).on("resize." + this.uniqueId + "." + c, function() {
        ...
        b.isFunction(this.settings.init) &&
        ...
        g.on("imagesLoaded." + c, function(a) {
          f.settings.autoSlideSize === !0 &&
            (f.$slides.hasClass("sp-animated") === !1 &&
              f._resetSlidesPosition(),
            f._calculateSlidesSize()),
            f.settings.autoHeight === !0 &&
              a.index === f.selectedSlideIndex &&
              f._resizeHeightTo(g.getSize().height);
        });
    },
    ...
    _updateSlidesPosition: function() {
      ...
      if (this.settings.autoSlideSize === !0)
          ...
          for (
            ...
            (a = this.getSlideAt(this.slidesOrder[c])),
              ...
              b.css(
                this.positionProperty,
                g -
                  (a.getSize()[this.sizeProperty] + this.settings.slideDistance)
              ),
        ...
        for (
          ...
          (b = this.$slides.find(".sp-slide").eq(this.slidesOrder[c])),
            b.css(
              this.positionProperty,
              f +
                d *
                  (c - this.middleSlidePosition) *
                  (e + this.settings.slideDistance)
            );
    },
          ...
          for (c = 0; c < this.slidesOrder.length; c++)
            (a = this.getSlideAt(this.slidesOrder[c])),
              ...
              (g =
                ...
                a.getSize()[this.sizeProperty] +
                this.settings.slideDistance);
        d = this.getSlideAt(this.selectedSlideIndex).getSize()[
          this.sizeProperty
        ];
      } else {
        for (
          e =
            (this.settings.rightToLeft === !0 &&
              "horizontal" === this.settings.orientation) == !0
              ? -1
              : 1,
            f =
              "horizontal" === this.settings.orientation
          ...
          (b = this.$slides.find(".sp-slide").eq(this.slidesOrder[c])),
            b.css(
              this.positionProperty,
              e * c * (f + this.settings.slideDistance)
            );
        d = f;
      }
      var h =
          ...
          for (var d = 0, e = this.breakpoints.length; e > d; d++)
            if (b(a).width() <= this.breakpoints[d].size) {
              if (this.currentBreakpoint !== this.breakpoints[d].size) {
                ...
                this.trigger(f),
                  b.isFunction(this.settings.breakpointReach) &&
                    this.settings.breakpointReach.call(this, f),
    ...
    _resizeSlides: function() {
      ...
      this.settings.autoSlideSize === !0
        ...
        : this.settings.autoHeight === !0 && (c = "auto"),
      ...
      if (
        ...
        this._moveTo(e, !1, function() {
          c._resetSlidesPosition(),
            ...
            b.isFunction(c.settings.gotoSlideComplete) &&
              c.settings.gotoSlideComplete.call(c, {
                type: "gotoSlideComplete",
                index: a,
                previousIndex: c.previousSlideIndex
              });
    ...
    _stopMovement: function() {
      ...
      if (
        ...
        "css-3d" === this.supportedAnimation
          ...
          (this.slidesPosition =
            "horizontal" === this.settings.orientation ? e : f);
      }
  ...
  (e.prototype = {
          ...
          return (
            f.checkImagesComplete(this.$slide, function() {
              (b.areImagesLoaded = !0),
                ...
                b.trigger({ type: "imagesLoaded." + c, index: b.index });
            }),
    ...
    calculateSize: function() {
      var a = this.$slide.width(),
        c = this.$slide.height();
      return (
        this.$slide.children().each(function(d, e) {
          var f = b(e);
          if (f.is(":hidden") !== !0) {
  ...
  var f = {
    ...
    checkIE: function() {
      ...
      b.indexOf("MSIE");
      return (
        -1 !== b.indexOf("MSIE") || b.match(/Trident.*rv\:11\./)
          ? (this.isIE = !0)
          : (this.isIE = !1),
        this.isIE
      );
        ...
        _thumbnailsOnUpdate: function() {
          ...
          this.$slides.find(".sp-thumbnail").each(function(c) {
            ...
            0 !== d.parent("a").length && (d = d.parent("a")),
              e > f
                ? d.appendTo(a.$thumbnails)
                : d.insertBefore(a.$thumbnails.find(".sp-thumbnail").eq(e));
          });
          ...
          this.$thumbnails.find(".sp-thumbnail").each(function(c) {
            ...
            b.each(this.thumbnails, function(b, c) {
              c.setSize(a.settings.thumbnailWidth, a.settings.thumbnailHeight),
                (a.thumbnailsSize +=
                  "horizontal" === a.thumbnailsOrientation
                    ? c.getSize().width
                    : c.getSize().height);
            }),
              ...
              (c =
                ...
                0 === this.$thumbnails.find(".sp-selected-thumbnail").length
                  ...
                  : Math.max(
                      ...
                      ].getPosition()[this.thumbnailsPositionProperty],
      ...
      d = {
        ...
        initConditionalImages: function() {
          (this.currentImageSize = this.previousImageSize = "default"),
            (this.isRetinaScreen =
              "undefined" != typeof this._isRetina && this._isRetina() === !0),
            this.on(
              "update." + c,
        ...
        _loadConditionalImage: function(a, c, d) {
          ...
          e.attr("class", a.attr("class")),
            ...
            "undefined" != typeof a.attr("width") &&
              e.attr("width", a.attr("width")),
            "undefined" != typeof a.attr("height") &&
              e.attr("height", a.attr("height")),
            "undefined" != typeof a.attr("alt") && e.attr("alt", a.attr("alt")),
            "undefined" != typeof a.attr("title") &&
        ...
        _loadRetinaImage: function(a, c) {
          ...
          if (
            ("undefined" != typeof a.attr("data-retina") &&
              ((d = !0), (e = a.attr("data-retina"))),
            "undefined" != typeof a.attr("data-src") &&
              (d === !1 && (e = a.attr("data-src")), a.removeAttr("data-src")),
            "" !== e)
          ) {
            var f = b(new Image());
            f.attr("class", a.attr("class")),
              ...
              "undefined" != typeof a.attr("width") &&
                f.attr("width", a.attr("width")),
              "undefined" != typeof a.attr("height") &&
                f.attr("height", a.attr("height")),
              "undefined" != typeof a.attr("alt") &&
      ...
      d = {
        ...
        _loadImage: function(a, c) {
          ...
          d.attr("class", a.attr("class")),
            ...
            "undefined" != typeof a.attr("width") &&
              d.attr("width", a.attr("width")),
            "undefined" != typeof a.attr("height") &&
              d.attr("height", a.attr("height")),
  ...
  (function(a, b) {
              ...
              .each(function() {
                ...
                "undefined" == typeof c.layers && (c.layers = []),
                  ...
                  b(this).hasClass("sp-static") === !1 &&
                    ("undefined" == typeof c.animatedLayers &&
                      (c.animatedLayers = []),
          ...
          "undefined" != typeof d &&
            b.each(d, function(a, f) {
              f.isVisible() === !0
                ? (e++,
                  e === d.length &&
                    (c.trigger({ type: "showLayersComplete", index: a }),
          ...
          "undefined" != typeof d &&
            b.each(d, function(a, f) {
              f.isVisible() === !1
                ? (e++,
                  e === d.length &&
                    (c.trigger({ type: "hideLayersComplete", index: a }),
    ...
    a.SliderProSlide.prototype.destroy = function() {
      "undefined" != typeof this.layers &&
        ...
        "undefined" != typeof this.animatedLayers &&
    ...
    (f.prototype = {
      ...
      _setStyle: function() {
        (this.styled = !0),
          ...
          "undefined" != typeof this.data.width &&
            this.$layer.css("width", this.data.width),
          "undefined" != typeof this.data.height &&
            this.$layer.css("height", this.data.height),
          "undefined" != typeof this.data.depth &&
      ...
      _setPosition: function() {
        ...
        (this.horizontalPosition =
          ...
          (this.verticalPosition =
            "undefined" != typeof this.data.vertical ? this.data.vertical : 0),
      ...
      show: function(a) {
        if (this.visible !== !0) {
          ...
          var b = this,
            c =
              "undefined" != typeof this.data.showOffset
                ? this.data.showOffset
                : 50,
            d =
              "undefined" != typeof this.data.showDuration
                ? this.data.showDuration / 1e3
                : 0.4,
            e =
              "undefined" != typeof this.data.showDelay
                ? this.data.showDelay
                : 10,
            f =
              "undefined" != typeof b.data.stayDuration
      ...
      hide: function(a) {
        if (this.visible !== !1) {
          var c = this,
            d =
              "undefined" != typeof this.data.hideOffset
                ? this.data.hideOffset
                : 50,
            e =
              "undefined" != typeof this.data.hideDuration
                ? this.data.hideDuration / 1e3
                : 0.4,
            f =
              "undefined" != typeof this.data.hideDelay
                ? this.data.hideDelay
                : 10;
          if (
            ((this.visible = !1),
              ...
              b.each(this.slides, function(a, b) {
                ...
                this._fadeSlideTo(c, 1, function() {
                  ...
                  b.each(e.slides, function(a, b) {
                    ...
                    b.isFunction(e.settings.gotoSlideComplete) &&
            ...
            "css-2d" === this.supportedAnimation
              ? (setTimeout(function() {
                  ...
                  (c[d.vendorPrefix + "transition"] =
                    "opacity " + d.settings.fadeDuration / 1e3 + "s"),
                    a.css(c);
                }, 100),
                a.on(this.transitionEvent, function(b) {
                  b.target === b.currentTarget &&
                    (a.off(d.transitionEvent),
      ...
      d = {
        ...
        initTouchSwipe: function() {
          ...
          this.settings.touchSwipe !== !1 &&
            ((this.touchSwipeEvents.startEvent =
              "touchstart." + c + " mousedown." + c),
            (this.touchSwipeEvents.moveEvent =
              "touchmove." + c + " mousemove." + c),
        ...
        _onTouchStart: function(a) {
          ...
          if (
            ...
            !(b(a.target).closest(".sp-selectable").length >= 1))
          ) {
            var c =
        ...
        _onTouchMove: function(a) {
          var b =
            "undefined" != typeof a.originalEvent.touches
              ...
              : a.originalEvent;
          (this.isTouchMoving = !0),
            this.$slider.hasClass("sp-swiping") === !1 &&
        ...
        _onTouchEnd: function(a) {
          ...
          if (
            ...
            if (Math.abs(d) < this.settings.touchSwipeThreshold)
              ...
              var h = this.slidesOrder[
                b.inArray(this.selectedSlideIndex, this.slidesOrder) - g
              ];
              this.settings.loop === !0
                ? this.gotoSlide(h)
                : "undefined" != typeof h
            ...
            ? "" !== this.captionContent
              ? (0 === parseFloat(this.$captionContainer.css("opacity"), 10) &&
                ...
                this._fadeCaptionTo(0, function() {
                  (a.captionContent = c),
                    "" !== c
                      ? (a.$captionContainer.html(a.captionContent),
                        a._fadeCaptionTo(1))
                      : a.$captionContainer.empty();
                }))
          ...
          "css-2d" === this.supportedAnimation
            ? (setTimeout(function() {
                ...
                (b[c.vendorPrefix + "transition"] =
                  "opacity " + c.settings.captionFadeDuration / 1e3 + "s"),
    ...
    var c = "ThumbnailTouchSwipe." + b.SliderPro.namespace,
      d = {
        ...
        _onThumbnailTouchStart: function(a) {
          ...
          if (
            ((this.thumbnailPreviousStartEvent = a.type),
            !(b(a.target).closest(".sp-selectable").length >= 1))
          ) {
            var d =
              "undefined" != typeof a.originalEvent.touches
        ...
        _onThumbnailTouchEnd: function(a) {
          ...
          (this.isThumbnailTouchMoving = !1),
            ...
            b.isFunction(this.settings.thumbnailsMoveComplete) &&
        ...
        _initVideo: function(a) {
          ...
          a.attr("data-video-init", !0).videoController(),
            a.on("videoPlay." + c, function() {
              ...
              d.trigger(c),
                b.isFunction(d.settings.videoPlay) &&
            ...
            a.on("videoPause." + c, function() {
              ...
              d.trigger(c),
                b.isFunction(d.settings.videoPause) &&
                  d.settings.videoPause.call(d, c);
            }),
            a.on("videoEnded." + c, function() {
              ...
              d.trigger(c),
                b.isFunction(d.settings.videoEnd) &&
                  d.settings.videoEnd.call(d, c);
            });
        },
            ...
            a.on("click." + c, function(c) {
              if (!d.$slider.hasClass("sp-swiping")) {
                ...
                var e,
                  ...
                  l = a.attr("href"),
                  m =
                    a.children("img").attr("width") ||
                    a.children("img").width(),
                  n =
                    a.children("img").attr("height") ||
          ...
          a.each(f, function(c, e) {
            ...
            b.player.on(e, function() {
              b.trigger({ type: f, video: d }),
                a.isFunction(b.settings[f]) &&
                  b.settings[f].call(b, { type: f, video: d });
            });
          });
        }
      },
    ...
    var e = { youtubeAPIAdded: !1, youtubeVideos: [] },
      f = function(b) {
        ...
        if ("undefined" != typeof c) d.call(this, b);
          ...
          (e.youtubeVideos.push({ video: b, scope: this }),
          e.youtubeAPIAdded === !1)
        ) {
          e.youtubeAPIAdded = !0;
            ...
            onStateChange: function(b) {
              switch (b.data) {
                case YT.PlayerState.PLAYING:
                  a.started === !1 &&
                    ((a.started = !0), a.trigger({ type: "start" })),
                    (a.state = "playing"),
                    a.trigger({ type: "play" });
                  break;
    ...
    var g = { vimeoAPIAdded: !1, vimeoVideos: [] },
      h = function(b) {
        if (((this.init = !1), "undefined" != typeof window.Vimeo))
          ...
          (g.vimeoVideos.push({ video: b, scope: this }),
          g.vimeoAPIAdded === !1)
        ) {
          g.vimeoAPIAdded = !0;
      ...
      (l.prototype._init = function() {
        ...
        this.$video.hasClass("jwplayer")
          ...
          : 0 !== this.$video.find("object[data*='jwplayer']").length &&
            (a = this.$video.find("object").attr("id")),
          ...
          this.player.onReady(function() {
            (b.ready = !0),
              ...
              b.player.onPlay(function() {
                b.started === !1 &&
                  ((b.started = !0), b.trigger({ type: "start" })),
                  (b.state = "playing"),
                  b.trigger({ type: "play" });
              }),

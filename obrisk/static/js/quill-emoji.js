!(function(e, o) {
  "object" == typeof exports && "object" == typeof module
    ? (module.exports = o(require("quill")))
    : "function" == typeof define && define.amd
    ? define(["quill"], o)
    : "object" == typeof exports
    ? (exports.QuillEmoji = o(require("quill")))
    : (e.QuillEmoji = o(e.Quill));
})(window, function(a) {
  return (function(a) {
    var r = {};
    function c(e) {
        ...
        return (function(a) {
          ...
          "./src/bitap/bitap_pattern_alphabet.js": function(e, o) {
            e.exports = function(e) {
              for (var o = {}, a = e.length, r = 0; r < a; r += 1)
                o[e.charAt(r)] = 0;
          ...
          "./src/bitap/bitap_search.js": function(e, o, a) {
            ...
            e.exports = function(e, o, a, r) {
              ...
              if (-1 !== y) {
                ...
                if (
                  ((h = Math.min(v, h)), -1 !== (y = e.lastIndexOf(o, g + j)))
                ) {
                  var k = I(o, {
                    errors: 0,
                    currentLocation: y,
                ...
                function j(e, o) {
                  ...
                  !(function(e, o) {
                    ...
                    (this.pattern = this.options.isCaseSensitive
                      ? e
                      : e.toLowerCase()),
                    this.pattern.length <= t &&
                      (this.patternAlphabet = p(this.pattern));
                }
                var e, o, a;
                return (
                  (e = j),
                  (o = [
                    {
                      ...
                      value: function(e) {
                        ...
                        var o = this.options,
                          ...
                          r = o.tokenSeparator;
                        if (this.pattern.length > a)
                          return _(e, this.pattern, r);
                        var c = this.options,
                          n = c.location,
                          d = c.distance,
                          i = c.threshold,
                ...
                if (a) {
                  ...
                  if (null != i)
                    if (d || ("string" != typeof i && "number" != typeof i))
                      if (_(i))
                        for (var m = 0, t = i.length; m < t; m += 1)
                          e(i[m], d, r);
                      else d && e(i, d, r);
                    ...
                    },
                    {
                      ...
                      value: function() {
                        ...
                        if (this.options.tokenize)
                          for (
                            var a = e.split(this.options.tokenSeparator),
                              r = 0,
                              c = a.length;
                            r < c;
                            r += 1
                          )
                            o.push(new n(a[r], this.options));
                        return {
                          tokenSearchers: o,
                    ...
                    },
                    {
                      ...
                      value: function() {
                        ...
                        if ("string" == typeof a[0]) {
                          for (var n = 0, d = a.length; n < d; n += 1)
                            this._analyze(
                              { key: "", value: a[n], record: n, index: n },
                              {
                                resultMap: r,
                                results: c,
                                tokenSearchers: e,
                          ...
                          return { weights: null, results: c };
                        }
                        for (var i = {}, m = 0, t = a.length; m < t; m += 1)
                          for (
                            var _ = a[m], l = 0, s = this.options.keys.length;
                            l < s;
                            l += 1
                          ) {
                            ...
                            if ("string" != typeof f) {
                              if (
                                ((i[f.name] = { weight: 1 - f.weight || 1 }),
                                f.weight <= 0 || 1 < f.weight)
                              )
                                throw new Error(
                        ...
                        if (null != n) {
                          ...
                          if ("string" == typeof n) {
                            ...
                            if (
                              ...
                              for (
                                var b = n.split(this.options.tokenSeparator),
                                  v = [],
                                  k = 0;
                                k < t.length;
                                k += 1
                                ...
                                for (var x = !1, S = 0; S < b.length; S += 1) {
                                  ...
                                  E.isMatch
                                    ? ((C[q] = E.score),
                                      ...
                                      v.push(E.score))
                                    : ((C[q] = 1),
                                      this.options.matchAllTokens || v.push(1)),
                                    this._log(
                                      'Token: "'
                                        .concat(q, '", score: ')
                                        .concat(C[q])
                              ...
                              y = v[0];
                              for (var L = v.length, O = 1; O < L; O += 1)
                                y += v[O];
                            ...
                            for (var P = 0, A = n.length; P < A; P += 1)
                              this._analyze(
                                {
                                  key: a,
                                  arrayIndex: P,
                      ...
                      value: function(e) {
                        ...
                        for (var c = 0, n = e.length; c < n; c += 1) {
                          ...
                          if (
                            ...
                            for (
                              var i = { item: d.item }, m = 0, t = r.length;
                              m < t;
                              m += 1
                            )
                              r[m](d, i);
    ...
    function(e, o, a) {
      ...
      function i(e) {
        return (
          (function(e) {
            if (Array.isArray(e)) {
              for (var o = 0, a = new Array(e.length); o < e.length; o++)
                a[o] = e[o];
              return a;
            }
          })(e) ||
      ...
      function l(e, o) {
        return !o || ("object" !== t(o) && "function" != typeof o)
          ? (function(e) {
        ...
        h = (function(e) {
          function r() {
            return (
              ...
              l(this, f(r).apply(this, arguments))
            );
          }
          var o, a, c;
          return (
            ...
            (c = [
              ...
              },
              {
                ...
                value: function(e, o) {
                  ...
                  a.classList.add(this.emojiClass),
                    a.classList.add(this.emojiPrefix + e.name),
                    (a.innerText = String.fromCodePoint.apply(
                      String,
                      i(r.parseUnicode(e.unicode))
                    )),
                    o.appendChild(a);
                }
              },
            ...
            (a = null) && _(o.prototype, a),
            c && _(o, c),
            r
          );
        })();
      (h.blotName = "emoji"),
        (h.className = "ql-emojiblot"),
        (h.tagName = "span"),
        (h.emojiClass = "ap"),
        (h.emojiPrefix = "ap-");
      var y = h,
        ...
        q = (function(e) {
          function n(e, o) {
            ...
            return (
              ...
              ((a =
                !(c = k(n).call(this, e, o)) ||
                ("object" !== b(c) && "function" != typeof c)
                  ? w(r)
                  : c).emojiList = o.emojiList),
              (a.fuse = new p.a(o.emojiList, o.fuse)),
              (a.quill = e),
              (a.onClose = o.onClose),
              (a.onOpen = o.onOpen),
              (a.container = document.createElement("ul")),
              a.container.classList.add("emoji_completions"),
              a.quill.container.appendChild(a.container),
              (a.container.style.position = "absolute"),
              (a.container.style.display = "none"),
              (a.onSelectionChange = a.maybeUnfocus.bind(w(a))),
              (a.onTextChange = a.update.bind(w(a))),
              (a.open = !1),
              (a.atIndex = null),
              (a.focusedButton = null),
              (a.isWhiteSpace = function(e) {
                var o = !1;
                return /\s/.test(e) && (o = !0), o;
              }),
              e.keyboard.addBinding(
                { key: 186, shiftKey: !0 },
                a.triggerPicker.bind(w(a))
              ),
              e.keyboard.addBinding(
                { key: 59, shiftKey: !0 },
                a.triggerPicker.bind(w(a))
            ...
            (a = [
              {
                ...
                value: function(e, o) {
                  ...
                  0 < e.length &&
                    this.quill.deleteText(e.index, e.length, m.a.sources.USER),
                  ...
                  this.quill.setSelection(e.index + 1, m.a.sources.SILENT),
                    (this.atIndex = e.index),
                    a.left + 250 > this.quill.container.offsetWidth
                      ? (this.container.style.left = a.left - 250 + "px")
                      : (this.container.style.left = a.left + "px"),
                    (this.container.style.top = a.top + a.height + "px"),
                    (this.open = !0),
              ...
              },
              {
                ...
                value: function() {
                  ...
                  this.buttons[0].classList.remove("emoji-active"),
                    ...
                    1 < this.buttons.length && this.buttons[1].focus();
                }
              },
              {
                key: "update",
                value: function() {
                  ...
                  this.query = this.quill.getText(
                    this.atIndex + 1,
                    e - this.atIndex - 1
                  );
                  try {
                    if (event && this.isWhiteSpace(this.query))
                      return void this.close(null);
                  } catch (e) {
                    console.warn(e);
                  }
                  ...
                  o.sort(function(e, o) {
                    ...
                    0 === o.length
                      ...
                      : (15 < o.length && (o = o.slice(0, 15)),
                        this.renderCompletions(o));
                }
              },
              {
                key: "maybeUnfocus",
                ...
                value: function(e) {
                  ...
                  try {
                    if (event) {
                      if ("Enter" === event.key || 13 === event.keyCode)
                        return (
                          this.close(e[0], 1),
                          void (this.container.style.display = "none")
                        );
                  ...
                  if (
                      ...
                      var a,
                        ...
                        c = E(
                          ...
                          E(
                            ...
                            E("span", { className: "unmatched" }, e.shortname)
                          )
                        );
                      n.container.appendChild(c),
                        (d[o] = c.firstChild),
                        d[o].addEventListener(
                          ...
                          function(e) {
                            if ("ArrowRight" === e.key || 39 === e.keyCode)
                              ...
                              if ((e.preventDefault(), a + 1 === d.length))
                                return void d[0].focus();
                              d[Math.min(d.length - 1, a + 1)].focus();
                            } else
                              "ArrowLeft" === e.key || 37 === e.keyCode
                                ? (e.preventDefault(),
                                  d[Math.max(0, a - 1)].focus())
                                : "ArrowDown" === e.key || 40 === e.keyCode
                                ? (e.preventDefault(),
                                  d[Math.min(d.length - 1, a + 1)].focus())
                    ...
                    window.innerHeight / 2 <
                      this.quill.container.getBoundingClientRect().top &&
                      0 < this.container.offsetHeight &&
      ...
      function E(e, o) {
        ...
        for (
          var r = arguments.length, c = new Array(2 < r ? r - 2 : 0), n = 2;
          n < r;
          n++
        )
          c[n - 2] = arguments[n];
      ...
      function M(e, o) {
        return !o || ("object" !== L(o) && "function" != typeof o)
          ? (function(e) {
              if (void 0 !== e) return e;
              throw new ReferenceError(
                "this hasn't been initialised - super() hasn't been called"
        ...
        A = (function(e) {
          function c(e, o) {
            ...
            !(function(e, o) {
              ...
              ((a = M(this, z(c).call(this, e, o))).quill = e),
              (a.toolbar = e.getModule("toolbar")),
              void 0 !== a.toolbar &&
                a.toolbar.addHandler("emoji", a.checkPalatteExist);
            ...
            (a = [
              {
                ...
                value: function() {
                  var e,
                    ...
                    r = this.quill;
                  (e = r),
                    (o = document.getElementById("emoji-palette"))
                      ? o.remove()
                      : (function(c) {
                          ...
                          var r = a.left + 250;
                          (e.id = "emoji-palette"),
                            (e.style.top = 10 + a.top + a.height + "px"),
                            r > c.container.offsetWidth
                              ? (e.style.left = a.left - 250 + "px")
                          ...
                          if (
                            ...
                            (m.id = "emoji-close-div"),
                              m.addEventListener("click", I, !1),
                              document
                          ...
                          [
                            ...
                            o.classList.add("emoji-tab"),
                              o.classList.add("filter-" + e.name);
                            var a = e.content;
                            (o.innerHTML = a),
                              (o.dataset.filter = e.type),
                              i.appendChild(o);
                    ...
                    this.quill.on("text-change", function(e, o, a) {
                      "user" === a && (I(), B(r));
                    });
                }
              }
      ...
      function R(e, n, d) {
        ...
        o.map(function(e) {
          ...
          o.appendChild(a),
            o.classList.add("bem"),
            o.classList.add("bem-" + e.name),
            o.classList.add("ap"),
            o.classList.add("ap-" + e.name);
          ...
          c &&
            c.addEventListener("click", function() {
              ...
              d.insertEmbed(i.index, "emoji", e, m.a.sources.USER),
                setTimeout(function() {
        ...
        Q = (function(e) {
          function n(e, o) {
            ...
            return (
              ...
              a.container.classList.add("textarea-emoji-control"),
              (a.container.style.position = "absolute"),
              (a.container.innerHTML = o.buttonIcon),
              a.quill.container.appendChild(a.container),
              a.container.addEventListener(
                "click",
                a.checkEmojiBoxExist.bind(F(a)),
                !1
              ),
              a
            );
            ...
            (a = [
              {
                ...
                value: function() {
                  ...
                  if (a) a.remove();
                    ...
                    (r.id = "textarea-emoji"),
                      this.quill.container.appendChild(r);

...
from obrisk.posts.forms import CommentForm, EventsForm, JobsForm, PostForm
from obrisk.posts.models import Comment, Events, Jobs, Post
...
class DetailEventsView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # Add in a QuerySet of all the images
        context['detail_events'] = Events.objects.all()

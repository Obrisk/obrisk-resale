...
class Classified(models.Model):
    ...
    city = models.CharField (max_length=100, default="Not Updated", null=False)
    district = models.CharField (max_length=100, default="Not Updated", null=False)
    street_area = models.CharField (max_length=100, default="Not Updated", null=False)
